...
public class Submarine extends javax.swing.JFrame implements Observer{
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnTomahawk, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
    ...
    public void setPosition(int value) {
       ...
       if(value>=60){
           ...
           btnTomahawk.setBackground(Color.magenta);
       }
       if(value>=80){
           btnTrident.setEnabled(true);
           btnTrident.setBackground(Color.YELLOW);
       }
       if(value<=20){
           btnShoot.setEnabled(false);
